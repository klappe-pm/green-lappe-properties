...
| [`../colors/gpm-brand-book.html`](gpm-brand-book.html) | The full editorial brand book (22 spreads). Self-contained; open in any browser. Canonical copy lives in `docs/branding/colors/`. | Humans, vendors, and as the rendered reference. |
...
full token set is [`../css/green-pm-tokens.css`](green-lappe-properties/branding/css/green-pm-tokens.css).
