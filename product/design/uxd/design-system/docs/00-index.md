...
- [`green-pm-tokens.css`](green-lappe-properties/design/uxd/design-system/green-pm-tokens.css) machine-readable token export
- [`tailwind.config.js`](green-lappe-properties/design/uxd/design-system/tailwind.config.js) Tailwind configuration mirroring tokens
