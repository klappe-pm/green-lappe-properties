...
This is the canonical project-local instruction file. Read and follow it
before making changes. It augments the user-scope policy in
`/Users/kevinlappe/.claude/`; it does not override the global passoff
location, naming, or safety rules.
