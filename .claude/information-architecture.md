...
1. Every changed durable file must live under an allowed top-level path: `README.md`, `AGENTS.md`, `CLAUDE.md`, `WARP.md`, `GEMINI.md`, `LLM-BREADCRUMBS.md`, `.claude/`, `.githooks/`, `.gitignore`, or `docs/`.
