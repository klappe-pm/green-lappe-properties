...
export default {
  ...
  // The canonical reset/element defaults live in src/styles/base.css (copied
  // from the locked design system). Disable Tailwind preflight so it does not
  // double-reset and fight the design-system base layer.
  corePlugins: {
    preflight: false,
  },
  plugins: [
