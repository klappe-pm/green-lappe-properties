...
The driving plan is [`docs/uxr/plans/Demographic Research Plan.md`](Demographic%20Research%20Plan.md). Reports methodology and metrics glossary live under [`docs/uxr/references/`](docs/uxr/references/).
...
- Backlog items go in [`docs/backlog/backlog.md`](green-lappe-properties/product/backlog.md) via the `/backlog` command (tags: `type:`, `priority:`, `area:`).
