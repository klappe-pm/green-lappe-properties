...
Forty-four specification documents plus four production CSS/JS asset files. The full v3 refactor of the previous monolithic style guide (`green-pm-style-guide.md`, 4,219 lines, now superseded).
...
- Style guide decomposed from one 4,219-line file into 44 modular spec docs.
