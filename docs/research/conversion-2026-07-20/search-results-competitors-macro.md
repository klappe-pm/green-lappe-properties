# search-results-competitors-macro
...
- Fed funds 3.50-3.75% (held 6/17/26); SEP median end-2026 3.8% (hawkish shift); end-2027 cluster 3.75-4.00%; 86.7% hold probability 7/29.
- 30-yr mortgage forecasts 2027: Fannie ~6.3-6.4%; MBA 6.5% flat through 2028. Rates NOT expected to fall materially.
- CPI June 2026: headline 3.5% YoY; shelter 3.3% (rent 2.8%); 5-yr breakeven 2.24%. Inflation hot, Fed biased hold/hike.
- Discount anchors: risk-free 4.6%; debt 6.5-7.4%; equity hurdle 10-12% (value-add convention); levered value-add targets 14-20%.
- Housing: LA median $910K (+0.7%); OC $1.49M (+1.4%); SD ~$922K-1.09M (FLAG broker-sourced high figure); Riverside $640-665K; King $889K (flat, inventory +16%); Snohomish $726K (inventory +29%). Rents: LA -1.4% YoY; Seattle metro $2,011 -0.8%; Casden forecast OC/Riv +2.2-2.3%/yr.
- Cost burden: 42% LA households rent-burdened; King ~48% of renters; Snohomish ~40%; SCAG region 43.6%.
- Housing need: CA 2.5M units short (HCD, auditor-caveated); WA 1.1M by 2044 (King ~337K, Snohomish ~143K).
- Childcare workforce housing (computed, labeled): CA lead teacher $21/hr = $3,640/mo gross; rent = 70-80% of gross in every study county (OC 77%, Riverside 72%, WA 79% at $14.69/hr median). Housing scarcity directly constrains care supply; supports owner-occupied provider housing thesis. CA educator poverty 2x other workers.
- Model anchors: keep HELOC 7.43% owner debt; platform equity discount 10-12%; rent escalation 2-2.5% CA, ~1-2% WA near-term; tuition escalation >= CPI 3%.
