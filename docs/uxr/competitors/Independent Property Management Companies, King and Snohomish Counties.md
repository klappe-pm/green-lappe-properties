...
```mermaid
graph LR
  subgraph independents
    rpa[real-property-associates]
    sja[sja-property-management]
    bell[bell-anderson-associates]
    brink[brink-property-management]
    np[north-pacific-property-management]
    joseph[the-joseph-group]
    gps[gps-renting]
    wpi[wpi-real-estate]
    spma[seattle-property-management-associates]
    spm[seattles-property-management]
    gp[gregory-property-management]
    gallagher[gallagher-properties]
